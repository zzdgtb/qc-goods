...
public class DateUtil {
     ...
     * @return
     */
    public static Date getDateSomeMinisBehind(int afterMinis) {
        long curren = System.currentTimeMillis();
        curren += 60 * 1000 * afterMinis;
        Date da = new Date(curren);
        return da;
    }
    /**
...
//      sdate = VeStr.Replace(sdate, "/", "-");
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(df.format(getDateSomeHoursBehind(5)));
        System.out.println(df.format(getDateSomeMinisBehind(5)));
        System.out.println(getDateSomeMinisBehind(5).before(getNow()));
        // 1361325960
